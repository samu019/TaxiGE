...
urlpatterns = [
    path('subscription/', views.panel_my_subscription, name='panel_my_subscription'),
    path('subscription/renew/', views.panel_subscription_renew, name='panel_subscription_renew'),
    path('calendar/', views.panel_calendar, name='panel_calendar'),
